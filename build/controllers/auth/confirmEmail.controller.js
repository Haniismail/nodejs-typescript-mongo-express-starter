...
exports.confirmEmail = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    const user = await UserRepo_1.default.getOneByObj({ token });
    if (!user)
    ...
    await UserRepo_1.default.oldUpdate(user, keystore === null || keystore === void 0 ? void 0 : keystore.primaryKey, keystore === null || keystore === void 0 ? void 0 : keystore.secondaryKey);
