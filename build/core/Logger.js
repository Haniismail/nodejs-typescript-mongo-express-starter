...
const logLevel = envVar_1.environment === 'development' ? 'debug' : 'warn';
let dir = envVar_1.logDirectory;
if (!dir)
...
exports.default = (0, winston_1.createLogger)({
    ...
    exitOnError: false,
    silent: envVar_1.environment === 'test' ? true : false,
});
